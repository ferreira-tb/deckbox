...
async getOcgCards() : Promise<Db_Card[]> {
    return await TAURI_INVOKE("get_ocg_cards");
},
async getTcgCards() : Promise<Db_Card[]> {
    return await TAURI_INVOKE("get_tcg_cards");
},
